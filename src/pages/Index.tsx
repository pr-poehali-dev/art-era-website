...
const Index = () => {
  ...
  const services = [
    {
      icon: 'Palette',
      title: 'Креативный работающий дизайн',
      description: 'Создаём эффективные дизайн-решения, которые не просто красивые, а работают на ваш результат'
    },
    {
      icon: 'Sparkles',
      title: 'Декорации для мероприятий',
      description: 'Разработка и производство уникальных декораций для выставок, презентаций и корпоративов'
    },
    {
      icon: 'Shirt',
      title: 'Мерч',
      description: 'Брендированная одежда и аксессуары: от дизайна до производства с учётом вашего фирменного стиля'
    },
    {
      icon: 'Gift',
      title: 'Сувенирная продукция',
      description: 'Широкий ассортимент сувениров с вашим логотипом для клиентов, партнёров и сотрудников'
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in-up">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Мы воплощаем в жизнь идеи наших клиентов. Приходите с концепцией — наша команда подхватит её, 
                разработает визуализацию и технологию изготовления на российском рынке, учитывая ваши сроки и бюджет.
              </p>

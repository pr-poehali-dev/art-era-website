  ...
  const services = [
    {
      ...
      description: 'Разработка уникальных концепций и визуализация ваших идей от эскиза до готового макета'
    },
    {
      icon: 'Printer',
      title: 'Печать промо-материалов',
      description: 'Полный цикл производства рекламной продукции: от визиток до широкоформатной печати'
    },
    {
      icon: 'Calendar',
      title: 'Организация мероприятий',
      description: 'Планирование и проведение промо-акций, презентаций и корпоративных событий под ключ'
    },
    {
      icon: 'Package',
      title: 'Сувенирная продукция',
      description: 'Разработка и производство брендированных сувениров и подарочной продукции с логотипом'
    }
  ];
